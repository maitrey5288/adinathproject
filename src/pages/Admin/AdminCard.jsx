  ...
  return (
    ...
    onMouseOut={handleMouseOut} className={` bg-bg-2   card w-[200px]   hover:shadow-md    cursor-pointer  rounded-lg   flex flex-col justify-start`}>
          ...
          <div className='absolute top-0 w-full  h-full flex items-center justify-center'>
            <button className='px-2 py-1  w-max h-max rounded-md  w3-animate-top bg-textcolor text-white'>View Details</button>
          </div>
        )}
            </div>
            ...
            <div className='text-gray-300'>{new Date(movie?.releaseDate).toLocaleDateString()}</div>
